...
import { ArrowLeft, Target, Users, Zap, Heart, TrendingUp } from "lucide-react"
      ...
      <div className="mx-auto max-w-4xl mobile-safe-padding py-12">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 mb-4">
            ...
            <span className="text-sm font-medium text-primary">Built by creators, for creators</span>
          </div>
          <h1 className="text-4xl font-bold mb-4">We Felt Your Pain. So We Fixed It.</h1>
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl font-semibold mb-4">The Origin Story You'll Relate To</h2>
          ...
          <section className="grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center text-center p-6 border border-border rounded-lg bg-card/50">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Why PostContent?</h2>
            <div className="space-y-4">
              <div className="border-l-2 border-primary pl-4">
                <h3 className="font-semibold mb-2">Built for Creators, Not Marketers</h3>
              ...
              <div className="border-l-2 border-primary pl-4">
                <h3 className="font-semibold mb-2">Your Voice, Amplified by AI</h3>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-2 border-primary pl-4">
                <h3 className="font-semibold mb-2">Ship Faster, Post Smarter</h3>
                <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Why Creators Choose Us Over Generic AI</h2>
            <div className="space-y-4">
              <div className="border-l-2 border-primary pl-4">
          ...
          <section className="rounded-lg border border-primary/20 bg-primary/5 p-8 text-center">
            ...
            <h2 className="text-2xl font-semibold mb-4">Join 10,000+ Creators Who Stopped Overthinking</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-primary text-primary-foreground font-semibold hover:bg-primary/90 hover:scale-105 transition-all"
              >
                Start Creating Now - It's Free
              </Link>
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-border font-semibold hover:bg-accent hover:scale-105 transition-all"
              >
                View Pricing
              </Link>
            </div>
